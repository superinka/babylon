...
function theme_styles() {
    ...
    wp_enqueue_style( 'owl', get_template_directory_uri() . '/owlcarousel/owl.carousel.min.css');
    wp_enqueue_style( 'owl-theme', get_template_directory_uri() . '/owlcarousel/owl.theme.default.min.css');
